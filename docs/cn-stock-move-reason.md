...
- 遇到板块集体爆发或持续性问题时，调用共享情绪框架，从大盘、成交、上涨宽度、产业链扩散、基本面验证和周期位置六个维度判断，并把逻辑持续性、盘面持续性与当前买点分开。
...
- `stock-sentiment-analysis`、`macro-news-check`、`stock-technical-analysis`：在情绪周期、宏观 tape 或技术结构会影响结论时协同分析。
