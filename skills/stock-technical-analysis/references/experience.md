...
- Keep `Active Playbook` compact. When it grows beyond roughly 100 lines, rewrite it into fewer higher-signal bullets before adding more.
...
- 2026-05-18: Added post-catalyst event-premium rules from a Japan theme-stock review. Ticker details omitted; the reusable lesson is to let price acceptance, event-day close/key level reclaim, and relative strength override a still-valid long-term narrative.
