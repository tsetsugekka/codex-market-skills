...
- `https://daytrading.monster/api/gamma/lite`: SPX/SPXW summary, expiry structure, levels and 0DTE five-minute context only. `https://daytrading.monster/api/camarilla/nikkei` and `https://daytrading.monster/api/camarilla/sse`: fixed-index Camarilla, gaps and available five-minute/MA/VWAP context. Match the market and session; missing current-session trajectories stay unavailable.
