...
- Apply the shared `Theme Catalyst Discipline` and `Local Market Data Discipline`; Japan pre-market reports must scan active global/Japan themes, not only Nikkei futures and PTS movers.
