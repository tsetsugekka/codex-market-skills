...
- Apply the shared `Theme Catalyst Discipline` and `Local Market Data Discipline`; do not skip theme-news scanning just because futures, macro data, or mega-cap earnings are available.
