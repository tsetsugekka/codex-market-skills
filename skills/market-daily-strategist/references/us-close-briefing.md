...
- Apply the shared `News Coverage Discipline` and `Optional Local / Private Data Discipline`; close-review reports must still scan active themes and after-hours catalysts, not only index closes.
