...
- Apply the shared `Theme Catalyst Discipline` and `Local Market Data Discipline`; close-review reports must scan after-close and next-session catalysts, not only index closes and today's hot sectors.
