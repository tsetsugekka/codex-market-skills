...
In this Codex desktop environment, live Yahoo/Kabutan fetching normally needs
network escalation. If the user asks for current mover data, run the helper with
