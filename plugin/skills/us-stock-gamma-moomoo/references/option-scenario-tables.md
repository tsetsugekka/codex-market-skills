...
- Use the user's requested or established timezone; otherwise state the selected timezone.
...
Compute the table in an actually available execution environment; label model assumptions and actual input timestamps.
