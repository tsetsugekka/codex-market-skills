...
- Apply the shared `Market News Discipline` and `Optional Local / Private Data Discipline`; close-review reports must still scan active market news and after-hours catalysts, not only index closes.
