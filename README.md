...
[![DayTrading.Monster 插件架构：用户入口、主 Skill、支持 Skill、数据源与输出](assets/architecture.zh-CN.png)](assets/architecture.zh-CN.png)

按问题选择入口，并按线索组合支持 Skill；不表示每次调用全部能力。点击图片查看大图。
